export const blogList = [
  {
    ...
    description: `
    Artificial Intelligence (AI) is revolutionizing the way we live, work, and interact with the world around us. From virtual assistants like Siri and Alexa to self-driving cars and predictive analytics, AI is transforming every industry and every aspect of our lives.
    In this blog, we'll explore what AI is, how it works, and its potential
   applications.
    What is AI?`,
    authorName: "John Doe",
